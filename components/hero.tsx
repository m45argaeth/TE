		...
		<section className="relative overflow-hidden">
			...
			<div className="mx-auto max-w-6xl px-6 pb-10 pt-20 sm:pt-28">
				<div className="mx-auto flex max-w-3xl flex-col items-center text-center">
					...
					<h1 className="animate-fade-up text-balance text-5xl font-semibold tracking-tight sm:text-6xl md:text-7xl">
						Token Explorer
					</h1>
					<p
				...
				<div
					...
					style={visualStyle}
				>
					<div className="rounded-3xl border bg-card/70 p-8 shadow-sm backdrop-blur-sm sm:p-12">
